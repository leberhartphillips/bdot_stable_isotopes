...
- Shareable report-integration file: `bdot_stable_isotope_screening_report.qmd`
...
- The shareable report is built from accepted outputs in `data/derived/` via `bdot_stable_isotope_screening_report.qmd`.
- Report-prep helper tables are generated by `scripts/report_prepare_derived_tables.R`.
...
1. `Rscript scripts/report_prepare_derived_tables.R`
2. `quarto render bdot_stable_isotope_screening_report.qmd`

Expected rendered output:

- `bdot_stable_isotope_screening_report.html`
